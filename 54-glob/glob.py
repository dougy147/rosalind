...
def needleman_wunsch(s,t):
    ...
    mat = [[_*-linear_gap_penalty for _ in range(len(t)+1)] for _ in range(len(s)+1)]
    for r in range(len(mat)):
        mat[r][0] = r*-linear_gap_penalty
    for r in range(1,len(mat)):
        for c in range(1,len(mat[r])):
            mat[r][c] = max(mat[r-1][c-1] + blosum62[(s[r-1],t[c-1])],
                            mat[r-1][c] - linear_gap_penalty,
                            mat[r][c-1] - linear_gap_penalty)
